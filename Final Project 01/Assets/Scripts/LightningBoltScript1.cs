...
namespace DigitalRuby.LightningBolt
{
    ...
    /// </summary>
    public enum LightningBoltAnimationMode1
    {
        /// <summary>
        /// No animation
        /// </summary>
    ...
    public class LightningBoltScript1 : MonoBehaviour
    {
        ...
        public LightningBoltAnimationMode1 AnimationMode = LightningBoltAnimationMode1.PingPong;
        ...
        private void SelectOffsetFromAnimationMode()
        {
            ...
            if (AnimationMode == LightningBoltAnimationMode1.None)
            {
                lineRenderer.material.mainTextureOffset = offsets[0];
                return;
            }
            else if (AnimationMode == LightningBoltAnimationMode1.PingPong)
            {
            ...
            else if (AnimationMode == LightningBoltAnimationMode1.Loop)
            {
                index = animationOffsetIndex++;
                if (animationOffsetIndex >= offsets.Length)
                {
        ...
        private void Start()
        {
            ...
            laser = GameObject.Find("Shot Spawn");
        ...
        private void Update()
        {
            lineRenderer.enabled = laser.GetComponent<LaserScript>().lineEnabled;
            StartPosition = laser.GetComponent<LaserScript>().lineStart;
            EndPosition = laser.GetComponent<LaserScript>().lineEnd;
